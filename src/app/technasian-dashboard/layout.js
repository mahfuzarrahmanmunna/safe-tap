...
export default function TechnasianLayout({ children }) {
  ...
  const notifications = [
    {
      ...
      read: false,
      type: "success",
      description: "You have been assigned a new laptop repair job",
    },
    {
      id: 2,
      ...
      read: false,
      type: "info",
      description: "Your soldering iron is due for maintenance",
    },
    {
      id: 3,
      ...
      read: true,
      type: "success",
      description: "Payment of $125.50 received for completed job",
    },
    {
      id: 4,
      title: "Job completed",
      ...
      read: true,
      type: "warning",
      description: "Remember to update job status to completed",
    },
  ];
    ...
    const loadUserData = async () => {
      try {
        ...
        if (savedUser) {
          ...
          // Load tool status
          const savedToolStatus = localStorage.getItem("toolStatus");
          if (savedToolStatus) {
          ...
          if (savedJobStatus) {
            setJobStatus(JSON.parse(savedJobStatus));
          }
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (
        jobModalRef.current &&
        !jobModalRef.current.contains(event.target) &&
        showJobModal
      ) {
      ...
      if (
        ...
        !toolModalRef.current.contains(event.target) &&
        showToolModal
      ) {
  ...
  }, [showLogoutConfirm, showJobModal, showToolModal]);
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      localStorage.removeItem("toolStatus");
  ...
  const updateToolStatus = (toolId, status) => {
    const newToolStatus = { ...toolStatus, [toolId]: status };
    setToolStatus(newToolStatus);
    localStorage.setItem("toolStatus", JSON.stringify(newToolStatus));
    toast.success(`Tool status updated to ${status}`);
  };

  // Update job status
  const updateJobStatus = (jobId, status) => {
    const newJobStatus = { ...jobStatus, [jobId]: status };
    setJobStatus(newJobStatus);
    localStorage.setItem("jobStatus", JSON.stringify(newJobStatus));
    toast.success(`Job status updated to ${status}`);

    // If job is completed, add to earnings
    if (status === "completed") {
      const jobEarnings = Math.floor(Math.random() * 200) + 50; // Random amount between $50-$250
      const newEarnings = earnings + jobEarnings;
      setEarnings(newEarnings);
      localStorage.setItem("earnings", newEarnings.toString());
      toast.success(`Job completed! Earned $${jobEarnings}`);
    }
  };
  ...
  const handleSearch = (query) => {
    ...
    const filteredItems = technasianMenuItems.filter(
      (item) =>
    ...
    const submenuItems = [];
    technasianMenuItems.forEach((item) => {
      if (item.submenu) {
  ...
  // Technasian menu items
  const technasianMenuItems = [
    {
      title: "Dashboard",
      icon: <LayoutDashboard className="w-5 h-5" />,
      href: "/technasian/dashboard",
      badge: null,
      color: "blue",
    ...
    },
    {
      ...
      href: "/technasian/jobs",
      badge: "5",
      color: "emerald",
      gradient: "from-emerald-500 to-emerald-600",
      submenu: [
        { title: "Active Jobs", href: "/technasian/jobs/active" },
        { title: "Completed Jobs", href: "/technasian/jobs/completed" },
        { title: "Pending Jobs", href: "/technasian/jobs/pending" },
        { title: "Job History", href: "/technasian/jobs/history" },
      ],
    },
    {
      title: "Schedule",
      icon: <Calendar className="w-5 h-5" />,
      href: "/technasian/schedule",
      badge: "3",
      color: "cyan",
      gradient: "from-cyan-500 to-cyan-600",
      submenu: [
        { title: "Today", href: "/technasian/schedule/today" },
        { title: "This Week", href: "/technasian/schedule/week" },
        { title: "This Month", href: "/technasian/schedule/month" },
        { title: "Calendar View", href: "/technasian/schedule/calendar" },
      ],
    },
    {
      title: "Tools",
      icon: <ToolCase className="w-5 h-5" />,
      href: "/technasian/tools",
      badge: null,
      color: "orange",
      gradient: "from-orange-500 to-orange-600",
      submenu: [
        { title: "My Tools", href: "/technasian/tools/my-tools" },
        { title: "Tool Status", href: "/technasian/tools/status" },
        { title: "Maintenance", href: "/technasian/tools/maintenance" },
        { title: "Request Tool", href: "/technasian/tools/request" },
      ],
    },
    {
      title: "Earnings",
      icon: <DollarSign className="w-5 h-5" />,
      href: "/technasian/earnings",
      badge: null,
      color: "green",
      gradient: "from-green-500 to-green-600",
      submenu: [
        { title: "Payment History", href: "/technasian/earnings/history" },
        { title: "Pending Payments", href: "/technasian/earnings/pending" },
        { title: "Invoices", href: "/technasian/earnings/invoices" },
        { title: "Tax Documents", href: "/technasian/earnings/tax" },
      ],
    },
    {
      title: "Performance",
      icon: <BarChart3 className="w-5 h-5" />,
      href: "/technasian/performance",
      badge: null,
      color: "teal",
      gradient: "from-teal-500 to-teal-600",
      submenu: [
        { title: "Job Statistics", href: "/technasian/performance/jobs" },
        { title: "Customer Ratings", href: "/technasian/performance/ratings" },
        {
          title: "Efficiency Metrics",
          href: "/technasian/performance/efficiency",
        },
        { title: "Skills Assessment", href: "/technasian/performance/skills" },
      ],
    },
    {
      title: "Customers",
      icon: <Users className="w-5 h-5" />,
      href: "/technasian/customers",
      badge: null,
      color: "blue",
      gradient: "from-blue-500 to-blue-600",
      submenu: [
        { title: "My Customers", href: "/technasian/customers/my-customers" },
        { title: "Customer Feedback", href: "/technasian/customers/feedback" },
        {
          title: "Follow-up Reminders",
          href: "/technasian/customers/follow-up",
        },
      ],
    },
    {
      ...
      href: "/technasian/knowledge",
      badge: null,
      color: "cyan",
      gradient: "from-cyan-500 to-cyan-600",
      submenu: [
        { title: "Repair Guides", href: "/technasian/knowledge/guides" },
        { title: "Technical Docs", href: "/technasian/knowledge/docs" },
        { title: "Video Tutorials", href: "/technasian/knowledge/tutorials" },
        { title: "FAQs", href: "/technasian/knowledge/faqs" },
      ],
    },
    {
      title: "Messages",
      icon: <MessageSquare className="w-5 h-5" />,
      href: "/technasian/messages",
      badge: "2",
      color: "amber",
    ...
    },
    {
      ...
      href: "/technasian/settings",
      badge: null,
      color: "gray",
      gradient: "from-gray-500 to-gray-600",
      submenu: [
        { title: "Profile", href: "/technasian/settings/profile" },
        { title: "Availability", href: "/technasian/settings/availability" },
        { title: "Notifications", href: "/technasian/settings/notifications" },
        { title: "Privacy & Security", href: "/technasian/settings/security" },
      ],
    },
  ];
  ...
  const getNotificationIcon = (type) => {
    switch (type) {
      case "success":
        return <CheckSquareIcon className="w-5 h-5 text-emerald-500" />;
      case "warning":
  ...
  const getPageTitle = () => {
    if (pathname === "/technasian/dashboard") return "Technasian Dashboard";
    if (pathname === "/technasian/jobs") return "My Jobs";
    if (pathname.startsWith("/technasian/jobs/")) return "Job Details";
    if (pathname === "/technasian/schedule") return "My Schedule";
    if (pathname.startsWith("/technasian/schedule/")) return "Schedule Details";
    if (pathname === "/technasian/tools") return "My Tools";
    if (pathname.startsWith("/technasian/tools/")) return "Tool Details";
    if (pathname === "/technasian/earnings") return "My Earnings";
    if (pathname.startsWith("/technasian/earnings/")) return "Earnings Details";
    if (pathname === "/technasian/performance") return "My Performance";
    if (pathname.startsWith("/technasian/performance/"))
      return "Performance Details";
    if (pathname === "/technasian/customers") return "My Customers";
    if (pathname.startsWith("/technasian/customers/"))
      return "Customer Details";
    if (pathname === "/technasian/knowledge") return "Knowledge Base";
    if (pathname.startsWith("/technasian/knowledge/"))
      return "Knowledge Details";
    if (pathname === "/technasian/messages") return "Messages";
    if (pathname === "/technasian/settings") return "Settings";
    if (pathname.startsWith("/technasian/settings/")) return "Settings Details";

    return "Technasian Dashboard";
  };

  const getBreadcrumbs = () => {
    const paths = pathname.split("/").filter(Boolean);
    const breadcrumbs = [{ name: "Dashboard", href: "/technasian/dashboard" }];
  ...
  if (pathname === "/technasian/messages/chat") {
    return <>{children}</>;
  }
      ...
      >
        ...
        <div className="p-6 border-b border-slate-700/50 bg-gradient-to-r from-slate-800/50 to-slate-900/50 backdrop-blur-sm">
          ...
          >
            <div className="relative group">
              ...
              >
                <Wrench className="absolute -top-1 -right-1 w-5 h-5 text-yellow-300 animate-pulse" />
        ...
        <nav className="flex-1 p-4 overflow-y-auto custom-scrollbar">
          <ul className="space-y-1.5">
            {technasianMenuItems.map((item, index) => (
              <li key={item.title}>
                <div>
                  {item.onClick ? (
                    <button
        ...
        {/* Earnings Display */}
        {!sidebarCollapsed && (
          <div className="p-4 border-t border-slate-700/50 bg-gradient-to-r from-green-900/30 to-emerald-900/30 backdrop-blur-sm">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="flex items-center mt-1">
                              <Wrench className="w-3 h-3 text-amber-500 mr-1" />
                              <span className="text-xs font-medium text-blue-600 dark:text-cyan-400 capitalize">
                                Technasian
                              </span>
                            </div>
                          </div>
          ...
          <div className="p-4 sm:p-6 lg:p-8">
            <div className="mb-6">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm">
                Manage your technical services and track your performance
              </p>
            </div>
            {children}
          </div>
