    ...
    <section ref={ref} className="relative overflow-hidden">
      ...
      <motion.div
        className={`absolute top-10 left-10 w-72 h-72 rounded-full mix-blend-multiply filter blur-xl ${
          theme === "dark" ? "bg-blue-800 opacity-20" : "bg-sky-200 opacity-30"
        }`}
        animate={{ y: [0, -30, 0] }}
      ...
      <div className="relative max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Experience the future of water purification with SAFETAP. Advanced
              technology, subscription-based service, and unmatched quality for
              your home and office in Bangladesh.
            </motion.p>
            ...
            >
              {features.map((feature, index) => (
                <div
                  key={index}
                  className={`flex items-center space-x-2 px-4 py-2 rounded-full shadow-md border ${
                    theme === "dark"
          ...
          >
            ...
            <div className="relative">
              ...
              >
                ...
                >
                  "Best water purifier service in Bangladesh!"
                </p>
                <p
            ...
            {/* Decorative Elements */}
            <div
              className={`absolute inset-0 rounded-full blur-3xl transform -translate-y-10 translate-x-10 ${
                theme === "dark"
