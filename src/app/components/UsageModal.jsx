            ...
            <div className="px-6 pb-12 -mt-10 md:px-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
                {comparisonData.map((item, idx) => (
                  ...
                  >
                    <div
                      className={`w-12 h-12 rounded-xl ${item.color} bg-opacity-10 flex items-center justify-center text-xl mb-3`}
                    >
                      {item.icon}
                    </div>
                    ...
                    <div className="w-full space-y-3 mb-6 text-xs font-semibold">
                      <div
                        className={`flex justify-between border-b pb-2 ${isDark ? "border-slate-700/50" : "border-slate-200/50"}`}
                      >
