...
const Droplet = dynamic(
  () => import("lucide-react").then((mod) => mod.Droplet),
  { ssr: false },
);
    ...
    slides: [
      {
        ...
        image:
          "https://i.ibb.co.com/Jwnf2wQs/1-lg-copper-alive-product-production.webp",
      ...
      },
      {
        ...
        description:
          "Enhances digestion and improves immunity with copper-infused water",
        image:
          "https://i.ibb.co.com/gMXpXPCH/types-of-web-development-services.jpg2",
      ...
      },
      {
        ...
        image:
          "https://i.ibb.co.com/gMXpXPCH/types-of-web-development-services.jpg3",
      ...
      },
      {
        ...
        description:
          "Complete removal of impurities with 5-stage filtration process",
        image:
          "https://i.ibb.co.com/gMXpXPCH/types-of-web-development-services.jpg4.jpg",
    ...
    slides: [
      {
        ...
        description:
          "Specialized filtration for Chattogram's unique water conditions",
      ...
      },
      {
        ...
        description:
          "Large capacity purification for industrial and residential use",
      ...
      },
      {
        ...
        description:
          "Extra protection against salt and mineral content in water",
    ...
    slides: [
      {
        ...
        description:
          "Advanced filtration for agricultural area water conditions",
