...
const EmailVerification = () => {
  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center p-4 ${isDark ? "bg-slate-900" : "bg-gray-50"}`}
    >
      <div
        className={`max-w-md w-full rounded-2xl shadow-xl p-8 ${isDark ? "bg-slate-800" : "bg-white"}`}
      >
          ...
          {status === "success" && (
            <>
              ...
              {qrCode ? (
                ...
                <div className="mt-4">
                  <FaQrcode
                    className={`text-4xl mx-auto mb-2 ${isDark ? "text-slate-600" : "text-gray-400"}`}
                  />
                  <p
              ...
              <p
                className={`text-xs mt-4 ${isDark ? "text-slate-500" : "text-gray-500"}`}
              >
